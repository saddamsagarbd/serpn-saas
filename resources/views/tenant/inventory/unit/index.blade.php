    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
        <div x-show="currentTab === 'purchase-order'" x-transition class="space-y-6">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">UOM</h2>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm text-gray-700 divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">UOM-101</td>
                            <td class="p-4 font-semibold text-gray-900">Kilogram</td>
                            <td class="p-4 font-mono text-xs text-gray-500">kg</td>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">UOM-102</td>
                            <td class="p-4 font-semibold text-gray-900">Square Feet</td>
                            <td class="p-4 font-mono text-xs text-gray-500">sqft</td>
                            <td class="p-4 text-center space-x-1">
                                <button class="bg-gray-100 text-gray-600 text-xs px-3 py-1.5 rounded hover:bg-indigo-50 hover:text-indigo-600 font-semibold transition">Edit</button>
                                <button class="bg-gray-100 text-red-600 text-xs px-3 py-1.5 rounded hover:bg-red-50 font-semibold transition">Delete</button>
                            </td>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">UOM-103</td>
                            <td class="p-4 font-semibold text-gray-900">Meter</td>
                            <td class="p-4 font-mono text-xs text-gray-500">m</td>
                            <td class="p-4 text-center space-x-1">
                                <button class="bg-gray-100 text-gray-600 text-xs px-3 py-1.5 rounded hover:bg-indigo-50 hover:text-indigo-600 font-semibold transition">Edit</button>
                                <button class="bg-gray-100 text-red-600 text-xs px-3 py-1.5 rounded hover:bg-red-50 font-semibold transition">Delete</button>
                            </td>
