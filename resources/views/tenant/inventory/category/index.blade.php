                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm text-gray-700 divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">CAT-101</td>
                            <td class="p-4 font-semibold text-gray-900">Category 1</td>
                            <td class="p-4 font-mono text-xs text-gray-500">N/A</td>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">CAT-102</td>
                            <td class="p-4 font-semibold text-gray-900">Category 2</td>
                            <td class="p-4 font-mono text-xs text-gray-500">N/A</td>
                            <td class="p-4 text-center space-x-1">
                                <button class="bg-gray-100 text-gray-600 text-xs px-3 py-1.5 rounded hover:bg-indigo-50 hover:text-indigo-600 font-semibold transition">Edit</button>
                                <button class="bg-gray-100 text-red-600 text-xs px-3 py-1.5 rounded hover:bg-red-50 font-semibold transition">Delete</button>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">CAT-103</td>
                            <td class="p-4 font-semibold text-gray-900">Category 3</td>
                            <td class="p-4 font-mono text-xs text-gray-500">N/A</td>
                            <td class="p-4 text-center space-x-1">
                                <button class="bg-gray-100 text-gray-600 text-xs px-3 py-1.5 rounded hover:bg-indigo-50 hover:text-indigo-600 font-semibold transition">Edit</button>
                                <button class="bg-gray-100 text-red-600 text-xs px-3 py-1.5 rounded hover:bg-red-50 font-semibold transition">Delete</button>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-bold text-indigo-600 font-mono">CAT-104</td>
                            <td class="p-4 font-semibold text-gray-900">Category 4</td>
                            <td class="p-4 font-mono text-xs text-gray-500">N/A</td>
                            <td class="p-4 text-center space-x-1">
                                <button class="bg-gray-100 text-gray-600 text-xs px-3 py-1.5 rounded hover:bg-indigo-50 hover:text-indigo-600 font-semibold transition">Edit</button>
                                <button class="bg-gray-100 text-red-600 text-xs px-3 py-1.5 rounded hover:bg-red-50 font-semibold transition">Delete</button>
