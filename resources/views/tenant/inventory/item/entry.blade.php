            ...
            <form action="{{ isset($item) ? route('tenant.inventory.item.update', $item->id) : route('tenant.inventory.item.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <select name="brand" class="w-full px-3.5 py-2 text-xs bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-slate-800 font-semibold">
